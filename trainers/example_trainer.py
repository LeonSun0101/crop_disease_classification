...
class ExampleTrainer(BaseTrainer,object):
    ...
    def train_step(self, images, labels):
        ...
        prec1, prec5 = self.compute_accuracy(infer.data, labels.data, topk=(1, 3))
    ...
    def get_loss(self, pred, label):
        ...
        if torch.cuda.is_available():
            criterion.cuda()
            #add by Leon
            #print("0000000000000000000000000000000000000",pred)
            #print("1111111111111111111111",label)
